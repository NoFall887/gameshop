...
const Navbar = () => {
    ...
    return (
        <nav className=" w-full   text-white bg-popover">
                    ...
                    <div className="flex items-center">
                        ...
                        <Link href="/" className="flex items-center space-x-2">
                            <Image
                                ...
                                height={40}
                            />
                            <span className="font-semibold text-lg">GameManiac</span>
                        </Link>
                    </div>
                    <div className="flex items-center space-x-4 relative">
                        ...
                        <div className="relative">
                            <button
                                ...
                                className="flex h-9 w-9 items-center justify-center absolute top-1/2 right-0 -translate-y-1/2 "
                            >
                                <FaSearch className=" text-gray-400" />
                            </button>
                            <Input
                                className={`focus:outline-none focus:bg-gray-900 pr-8 ${
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent className="text-white">
                                {languages.map((lang) => (
                                    ...
                                    >
                                        <div className="w-5 h-5">{lang.logo}</div>
                                        <span className="text-sm">{lang.lang}</span>
                                    </DropdownMenuItem>
                                ))}
                            </DropdownMenuContent>
                        </DropdownMenu>
            ...
            <div className="container flex items-center justify-between h-12 max-w-6xl mx-auto px-6">
